          ...
          <div
            ...
            onClick={() => handleCardClick(
              <>
                ...
                <p className="text-lg">
                  <span className='font-bold'>I</span> made this app in my spare time during the winter holidays, because i was bored. i worked with Vue.js and i never worked with it before. it went well
                </p>
            ...
            className={`reveal p-6 rounded-lg shadow-lg transition-transform duration-700 ease-out cursor-pointer ${inView3 ? 'transform translate-y-0 opacity-100' : 'transform translate-y-20 opacity-0'} ${darkMode ? 'bg-gray-700 text-white' : 'bg-gray-100 text-black'} hover:shadow-2xl hover:scale-105`}
          >
            <h3 className="text-2xl font-semibold mb-4">My own Weather App</h3>
            <p className="text-lg fw-tahoma">
              <span className='font-bold'>I</span> made this app in my spare time during the winter holidays, because i was bored. i worked with Vue.js and i never worked with it before. it went really well for a propgramming language i didn't understand at first
            </p>
            <a href='https://resplendent-bubblegum-8e8dac.netlify.app/' target="_blank" rel="noopener noreferrer">
              <img src={Weatherapp} alt="Weather app" />
            </a>
